...
class MiniMaxH3BlockSwapArgs:
    ...
    def build(self, block_to_swap, prefetch, prefetch_count, pin_memory, disk_workers, dtype):
        return (H3BlockSwap(enabled=True, block_to_swap=block_to_swap, prefetch=prefetch,
